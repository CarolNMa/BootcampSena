document.addEventListener("DOMContentLoaded", function () {
    ...
    const numJugadores = parseInt(urlParams.get("jugadores")) || 2;
    const jugadoresContainer = document.getElementById("jugadores-container");
    const btnRegistrar = document.getElementById("btn-registrar");

    console.log("Jugadores seleccionados:", numJugadores);
    ...
    btnRegistrar.addEventListener("click", async function () {
        ...
        try {
            const url = 'http://localhost/Bootcamp1/MagicalCriatures/backend/crearJugador.php';
